...
CREATE or replace  VIEW MAKPSB.ACTUAL_DYN_REPORT (ID, NAME, PATH, CODE, VERSION, SQL_TEXT, PARAMS, COLUMNS, VIEW_COLUMNS, VIEW_NAME, PERSISTENCEUNIT, DATASOURCE, DB_USER, DB_PASSWORD, DB_DRIVER, DB_URL) AS(
SELECT ID, NAME, PATH, DN.CODE, DN.VERSION, SQL_TEXT, PARAMS, COLUMNS, VIEW_COLUMNS, VIEW_NAME, PERSISTENCEUNIT, DATASOURCE, DB_USER, DB_PASSWORD, DB_DRIVER, DB_URL
FROM (
