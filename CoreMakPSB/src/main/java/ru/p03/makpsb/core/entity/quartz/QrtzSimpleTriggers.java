 ...
 */
@Entity
@Table(name = "QRTZ_SIMPLE_TRIGGERS", catalog = "", schema = "MAKPSB")
@XmlRootElement
@NamedQueries({
...
public class QrtzSimpleTriggers implements Serializable {
    ...
    public String toString() {
        return "ru.p03.makpsb.core.entity.quartz.QrtzSimpleTriggers[ qrtzSimpleTriggersPK=" + qrtzSimpleTriggersPK + " ]";
    }
