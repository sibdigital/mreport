 ...
 */
@Entity
@Table(name = "QRTZ_SCHEDULER_STATE", catalog = "", schema = "MAKPSB")
@XmlRootElement
@NamedQueries({
...
public class QrtzSchedulerState implements Serializable {
    ...
    public String toString() {
        return "ru.p03.makpsb.core.entity.quartz.QrtzSchedulerState[ qrtzSchedulerStatePK=" + qrtzSchedulerStatePK + " ]";
    }
