 ...
 */
@Entity
@Table(name = "QRTZ_FIRED_TRIGGERS", catalog = "", schema = "MAKPSB")
@XmlRootElement
@NamedQueries({
...
public class QrtzFiredTriggers implements Serializable {
    ...
    public Integer getIsNonconcurrent() {
        return isNonconcurrent;
    }

    public void setIsNonconcurrent(Integer isNonconcurrent) {
        this.isNonconcurrent = isNonconcurrent;
    }

    public Integer getRequestsRecovery() {
        return requestsRecovery;
    }

    public void setRequestsRecovery(Integer requestsRecovery) {
    ...
    public String toString() {
        return "ru.p03.makpsb.core.entity.quartz.QrtzFiredTriggers[ qrtzFiredTriggersPK=" + qrtzFiredTriggersPK + " ]";
    }
