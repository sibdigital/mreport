 ...
 */
@Entity
@Table(name = "QRTZ_PAUSED_TRIGGER_GRPS", catalog = "", schema = "MAKPSB")
@XmlRootElement
@NamedQueries({
...
public class QrtzPausedTriggerGrps implements Serializable {
    ...
    public String toString() {
        return "ru.p03.makpsb.core.entity.quartz.QrtzPausedTriggerGrps[ qrtzPausedTriggerGrpsPK=" + qrtzPausedTriggerGrpsPK + " ]";
    }
