 ...
 */
@Entity
@Table(name = "QRTZ_SIMPROP_TRIGGERS", catalog = "", schema = "MAKPSB")
@XmlRootElement
@NamedQueries({
...
public class QrtzSimpropTriggers implements Serializable {
    ...
    public String toString() {
        return "ru.p03.makpsb.core.entity.quartz.QrtzSimpropTriggers[ qrtzSimpropTriggersPK=" + qrtzSimpropTriggersPK + " ]";
    }
